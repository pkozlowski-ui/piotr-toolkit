...
`<katalog domowy>/.claude/plugins/cache/*/motion-toolkit/<najwyższa wersja>/skills/improve-animations/`
Znajdź je narzędziem **Glob** (wzorzec `**/motion-toolkit/*/skills/improve-animations/*.md` z `path`
...
pod `plugins/motion-toolkit/skills/improve-animations/`.
